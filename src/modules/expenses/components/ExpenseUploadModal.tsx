...
export function ExpenseUploadModal({ isOpen, onClose, onSuccess }: ExpenseUploadModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-[#020617]/80 backdrop-blur-md animate-fade-in">
      <div className="bg-[#0f172a] border border-[#d4af37]/20 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-scale-in">
        
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#d4af37]/10 bg-[#d4af37]/5">
